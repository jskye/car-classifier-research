...
# training set
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/" $CLASSIFIER_DIR_FB"/haar.rab.24x20s.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/"$CLASSIFIER_DIR_FB"/hog.rab.24x20s.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/"$CLASSIFIER_DIR_FB"/lbp.rab.24x20s.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/"$CLASSIFIER_DIR_FB"/haar.gab.24x20s.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/"$CLASSIFIER_DIR_FB"/hog.gab.24x20s.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/"$CLASSIFIER_DIR_FB"/lbp.gab.24x20s.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
python $DETECT_SCRIPT $LABELLED_DATA_DIR_FB"/trainingset.noisy/"$CLASSIFIER_DIR_FB"/cars3.xml" $LABELLED_DATA_DIR_FB"/trainingset_100.txt" $TEST_RESULTS_DIR_FB $TEST_RESULTS_DIR_FB $COLORSPACE 2 F
